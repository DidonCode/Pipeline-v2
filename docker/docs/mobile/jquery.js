 ...
 * Copyright jQuery Foundation and other contributors; Licensed MIT */ !(function (t) {
	...
	(y.cleanData =
		...
		(y.widget = function (t, i, e) {
			...
			return (
				...
				(n.prototype = y.widget.extend(o, { widgetEventPrefix: (s && o.widgetEventPrefix) || t }, h, {
					constructor: n,
					namespace: a,
					widgetName: t,
					widgetFullName: r,
		...
		(y.widget.extend = function (t) {
			for (var e, i, s = a.call(arguments, 1), n = 0, o = s.length; n < o; n++) for (e in s[n]) (i = s[n][e]), h.call(s[n], e) && void 0 !== i && (y.isPlainObject(i) ? (t[e] = y.isPlainObject(t[e]) ? y.widget.extend({}, t[e], i) : y.widget.extend({}, i)) : (t[e] = i));
			return t;
		}),
		...
		(y.Widget.prototype = {
			...
			_on: function (n, o, t) {
				...
				'boolean' != typeof n && ((t = o), (o = n), (n = !1)),
					t ? ((o = h = y(o)), (this.bindings = this.bindings.add(o))) : ((t = o), (o = this.element), (h = this.widget())),
			...
			_trigger: function (t, e, i) {
				var s,
					n,
					o = this.options[t];
				if (((i = i || {}), ((e = y.Event(e)).type = (t === this.widgetEventPrefix ? t : this.widgetEventPrefix + t).toLowerCase()), (e.target = this.element[0]), (n = e.originalEvent))) for (s in n) s in e || (e[s] = n[s]);
		...
		y.each({ show: 'fadeIn', hide: 'fadeOut' }, function (o, h) {
			y.Widget.prototype['_' + o] = function (e, t, i) {
				var s,
					n = (t = 'string' == typeof t ? { effect: t } : t) ? (!0 !== t && 'number' != typeof t && t.effect) || h : o;
	...
	(x = Math.max),
		...
		(y.position = {
			scrollbarWidth: function () {
				...
				var t,
					e = y("<div style='display:block;position:absolute;width:200px;height:200px;overflow:hidden;'><div style='height:300px;width:auto;'></div></div>"),
					i = e.children()[0];
		...
		(y.fn.position = function (p) {
			...
			var d,
				...
				m,
				t,
				_ = 'string' == typeof (p = y.extend({}, p)).of ? y(document).find(p.of) : y(p.of),
	...
	(y.ui.focusable = function (t, e) {
		...
		return 'area' === h
			? ((s = (i = t.parentNode).name), !(!t.href || !s || 'map' !== i.nodeName.toLowerCase()) && 0 < (s = y("img[usemap='#" + s + "']")).length && s.is(':visible'))
			: (/^(input|select|textarea|button|object)$/.test(h) ? (n = !t.disabled) && (o = y(t).closest('fieldset')[0]) && (n = !o.disabled) : (n = ('a' === h && t.href) || e),
				n &&
					y(t).is(':visible') &&
					(function (t) {
	...
	y.widget('ui.resizable', y.ui.mouse, {
		...
		_setupHandles: function () {
			...
			if (
				...
				for ('all' === this.handles && (this.handles = 'n,e,s,w,se,sw,ne,nw'), i = this.handles.split(','), this.handles = {}, e = 0; e < i.length; e++) (s = 'ui-resizable-' + (t = String.prototype.trim.call(i[e]))), (n = y('<div>')), this._addClass(n, 'ui-resizable-handle ' + s), n.css({ zIndex: o.zIndex }), (this.handles[t] = '.ui-resizable-' + t), this.element.children(this.handles[t]).length || (this.element.append(n), (this._addedHandles = this._addedHandles.add(n)));
			(this._renderAxis = function (t) {
				...
				for (e in ((t = t || this.element), this.handles))
					this.handles[e].constructor === String
						...
						this.elementIsWrapper && this.originalElement[0].nodeName.match(/^(textarea|input|select|button)$/i) && ((i = y(this.handles[e], this.element)), (s = /sw|ne|nw|se|n|s/.test(e) ? i.outerHeight() : i.outerWidth()), (i = ['padding', /ne|nw|n/.test(e) ? 'Top' : /se|sw|s/.test(e) ? 'Bottom' : /^e$/.test(e) ? 'Right' : 'Left'].join('')), t.css(i, s), this._proportionallyResize()),
		...
		_mouseStart: function (t) {
			...
			return (
				...
				s.containment && ((e += y(s.containment).scrollLeft() || 0), (i += y(s.containment).scrollTop() || 0)),
		...
		_mouseDrag: function (t) {
			...
			return (
				...
				i && ((e = i.apply(this, [t, s, e])), this._updateVirtualBoundaries(t.shiftKey), (this._aspectRatio || t.shiftKey) && (e = this._updateRatio(e, t)), (e = this._respectSize(e, t)), this._updateCache(e), this._propagate('resize', t), (e = this._applyChanges()), !this._helper && this._proportionallyResizeElements.length && this._proportionallyResize(), y.isEmptyObject(e) || (this._updatePrevProperties(), this._trigger('resize', t, this.ui()), this._applyChanges())),
				!1
			);
		},
		...
		_renderProxy: function () {
			...
			(this.elementOffset = t.offset()),
				this._helper
					? ((this.helper = this.helper || y('<div></div>').css({ overflow: 'hidden' })),
		...
		y.ui.plugin.add('resizable', 'containment', {
			...
			resize: function (t) {
				...
				a[0] !== document && /static/.test(a.css('position')) && (h = s),
					n.left < (e._helper ? s.left : 0) && ((e.size.width = e.size.width + (e._helper ? e.position.left - s.left : e.position.left - h.left)), o && ((e.size.height = e.size.width / e.aspectRatio), (t = !1)), (e.position.left = i.helper ? s.left : 0)),
			...
			resize: function () {
				...
				(i.grid = a),
					...
					/^(se|s|e)$/.test(h)
						...
						: /^(ne)$/.test(h)
							? ((e.size.width = d), (e.size.height = c), (e.position.top = o.top - p))
							: /^(sw)$/.test(h)
								? ((e.size.width = d), (e.size.height = c), (e.position.left = o.left - u))
								: ((c - l <= 0 || d - r <= 0) && (t = e._getPaddingPlusBorderDimensions(this)), 0 < c - l ? ((e.size.height = c), (e.position.top = o.top - p)) : ((c = l - t.height), (e.size.height = c), (e.position.top = o.top + n.height - c)), 0 < d - r ? ((e.size.width = d), (e.position.left = o.left - u)) : ((d = r - t.width), (e.size.width = d), (e.position.left = o.left + n.width - d)));
			},
		});
	y.ui.resizable;
});
			...
			prototype: {
				...
				menuPosition: function (t) {
					...
					if ((g ? ((e = M ? d - r - w : w), (i = this.opts.bottomToTopSubMenus ? -h - T : m + T)) : ((e = M ? w - r : d - w), (i = this.opts.bottomToTopSubMenus ? m - T - h : T)), this.opts.keepInViewport)) {
						var y = l + e,
							I = c + i;
						if ((M && f > y ? (e = g ? f - y + e : d - w) : !M && y + r > f + b && (e = g ? f + b - r - y + e : w - r), g || (S > h && I + h > v + S ? (i += v + S - h - I) : (h >= S || v > I) && (i += v - I)), (g && (I + h > v + S + 0.49 || v > I)) || (!g && h > S + 0.49))) {
							var x = this;
